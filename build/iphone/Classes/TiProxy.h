...
//Rare exceptions to indicate a bug in the _instantweatherapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for InstantWeatherApp proxies.
 */
