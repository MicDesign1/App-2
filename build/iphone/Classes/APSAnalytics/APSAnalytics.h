 ...
 * to send analytic data that can be viewed on the InstantWeatherApp Dashboard.
 *
 * For information on getting started with InstantWeatherApp Platform Services,
