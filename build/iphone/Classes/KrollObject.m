...
//@interface InstantWeatherAppObject : NSObject
//@end

@interface InstantWeatherAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[InstantWeatherAppObject class]])
		{
			for (NSString *key in [[(InstantWeatherAppObject*)o modules] allKeys])
			{
