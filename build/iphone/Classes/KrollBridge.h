...
@interface InstantWeatherAppObject : KrollCoverageObject {
#else
@interface InstantWeatherAppObject : KrollObject {
#endif
@private
...
extern NSString * InstantWeatherApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	InstantWeatherAppObject *_instantweatherapp;
    KrollObject* console;
	BOOL shutdown;
