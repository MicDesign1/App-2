...
/**
 Base class for all InstantWeatherApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the InstantWeatherApp view hierarchy (such as wrapped iOS UIViews) was touched.
