...
// in simulator we redefine to format for InstantWeatherApp Developer console
...
{\
	NSString * exceptionName = [@"org.instantweatherapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.instantweatherapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIInstantWeatherAppNativeItemNone = -1, 
	UIInstantWeatherAppNativeItemSpinner = -2,
	UIInstantWeatherAppNativeItemProgressBar = -3,
	
	UIInstantWeatherAppNativeItemSlider = -4,
	UIInstantWeatherAppNativeItemSwitch = -5,
	UIInstantWeatherAppNativeItemMultiButton = -6,
	UIInstantWeatherAppNativeItemSegmented = -7,
	
	UIInstantWeatherAppNativeItemTextView = -8,
	UIInstantWeatherAppNativeItemTextField = -9,
	UIInstantWeatherAppNativeItemSearchBar = -10,
	
	UIInstantWeatherAppNativeItemPicker = -11,
	UIInstantWeatherAppNativeItemDatePicker = -12,
	
	UIInstantWeatherAppNativeItemInfoLight = -13,
	UIInstantWeatherAppNativeItemInfoDark = -14,
	
	UIInstantWeatherAppNativeItemDisclosure = -15,
	
	UIInstantWeatherAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all InstantWeatherApp instances of
